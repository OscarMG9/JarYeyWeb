    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            if (isset($_POST['fecha_inicio']) && isset($_POST['fecha_fin'])) {
                ...
                $sql = "SELECT productos.nombreProducto, ventas.precio_producto, ventas.cantidad_producto, ventas.precio_total, cuentaspersonal.Usuario FROM ventas INNER JOIN cuentaspersonal ON ventas.idCuenta = cuentaspersonal.idCuenta 
