...
if(isset($_POST['idProducto'])) {
    ...
    // Consultar la base de datos para obtener la cantidad disponible del producto
    $consulta = "SELECT cantidadProducto FROM productos WHERE idProducto = $idProducto";
