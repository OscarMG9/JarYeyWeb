<?php
    ...
    include("../navigationEmpleado/navbarCopy.php");
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="../backend/admin/ventaEmpleado/venta.php" id="formulario-venta" method="POST" onsubmit="return validarDatosVenta()">
                        <div class="row">
                            ...
                            <div class="col-4 form-group">
                                ...
                                <select name="idCuenta" id="idCuenta" class="form-control" style="border-bottom: 2px solid #0D0D0D;background-color: #ffffff;">
                                    ...
                                    <?php
                                        $query = "SELECT idCuenta, idRole, usuario FROM cuentaspersonal WHERE idRole = 2";
