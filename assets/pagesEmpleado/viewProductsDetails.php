...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../css/viewProductsDetails2.css">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 my-3">
                        ...
                        <div class="mt-3">
                            ...
                            <textarea type="text" name="" id="" class="custom-file-input form-control fw-bold" disabled><?php echo $producto['descripcionProducto']?></textarea>
                        </div>
                    </div>
                </div>
            <div class="text-center mt-4">
                <a class="btn btn-cancel mb-2" href="../pagesEmpleado/Dashboard.php">Regresar</a>
            </div>
        </form>
    </div>
