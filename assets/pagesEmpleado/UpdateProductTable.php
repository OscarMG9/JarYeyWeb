...
<body>
    <div class="form-container">
        ...
        <form action="" method="POST" enctype="multipart/form-data" onsubmit="return validarDatosRegistroAct()">
            <div class="form-row">
                <div class="form-group col-md-6 image-upload">
                    <label for="imagenInput">Seleccionar imagen</label>
                    <input type="file" name="imagen" id="imagenInput" accept="image/png">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="presentacion" id="idPresentacion" class="form-control">
                        <?php
    ...
    <script src="../js/validacionesActualizarProducto.js"></script>
